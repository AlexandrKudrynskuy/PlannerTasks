...
namespace DLL.Context
{
    public class PlannerTasksContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<User>().HasData(new User { Id = 4, Login = "Igor", Password = "1", Name = "Igor", SurName = "Романченко", TypeUser = TypeUser.Admin, Phone = "09690000001", Email = "roma@gmail.com", Photo = "" });
            modelBuilder.Entity<User>().HasData(new User { Id = 5, Login = "Ivan", Password = "1", Name = "Ivan", SurName = "Романченко", TypeUser = TypeUser.Worker, Phone = "09690000001", Email = "roma@gmail.com", Photo = "" });
            ...
            modelBuilder.Entity<MyTask>().HasData(new MyTask { Id = 1, Name="TaskPlaner", Description="Task Planer", PriorityId=1, StatusId=1, TypeTaskId=1, AdminId=2, WorkerId=1});
